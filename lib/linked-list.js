...
class LinkedList {
    ...
    */
    findMax() {
        ...
        // max -> assign head value
        let max = this.#head.value;

        // while current, check if current is > max, if so update max, incr. current
        while (current) { // if current is null, this loop will not run
     ...
     */
    getAtIndex(index) {
        // if (this.length() < index ) { // O(n), but can check this while doing the main loop?
        //     return null;
        // }
    ...
    */
    getFirst() {
        // this is not actually tested the first grouping of tests "addFirst and getFirst"
        throw new Error("This method hasn't been implemented yet!");
    }
